...
void BatteryPower(){
  ...
  Serial.print("BatTestPin:");Serial.println(digitalRead(PIN_BATTEST));
  uint8_t i;
  for(i=0;i<10;i++){
  ...
  adc=adcc/10;
  Serial.print("电池ADC:");Serial.println(adc);
  if(adc>2320){
    adc=2320; 
  }
  //1800对应3.4V
  ...
  Serial.print("电量");Serial.print(PRINTER_BATTERY);Serial.println("%");
